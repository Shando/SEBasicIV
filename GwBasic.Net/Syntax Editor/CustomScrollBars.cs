...
namespace GwBasic.Net
{
    ...
    {
        private void synBox1_ScrollbarsUpdated(object sender, EventArgs e)
        {
            AdjustScrollbars();
        }
        ...
        {
            AdjustScrollbar(vMyScrollBar, synBox1.VerticalScroll.Maximum, synBox1.VerticalScroll.Value,
                synBox1.ClientSize.Height);
            AdjustScrollbar(hMyScrollBar, synBox1.HorizontalScroll.Maximum, synBox1.HorizontalScroll.Value,
                synBox1.ClientSize.Width);

            AdjustScrollbar(vScrollBar, synBox1.VerticalScroll.Maximum, synBox1.VerticalScroll.Value,
                synBox1.ClientSize.Height);
            AdjustScrollbar(hScrollBar, synBox1.HorizontalScroll.Maximum, synBox1.HorizontalScroll.Value,
                synBox1.ClientSize.Width);
        }
